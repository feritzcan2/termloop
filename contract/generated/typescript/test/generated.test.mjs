...
test("generated validator rejects cross-provider Git-host identities", () => {
  const result = [{
    ...
    matches: [{
      ...
      head_repository_name: "widget-fork", checks: "unknown", review: "reviewRequired",
      mergeability: "unknown", updated_at_epoch_ms: 1,
    }],
  }];
