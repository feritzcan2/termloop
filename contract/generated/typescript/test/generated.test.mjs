...
test("MCP tool settings projection is closed, bounded, and revisioned", () => {
  const roleSets = [
    ...
    [new Set(MCP_WORKER_TOOLS), "worker"],
  ];
  const result = {
    stateRevision: 7,
