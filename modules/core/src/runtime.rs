...
impl CoreRuntime {
    ...
    pub fn handle(&mut self, method: &str, params: Value) -> Result<Value, CoreError> {
        match method {
            ...
            "task.updateDeveloperNotes" => self.update_task_developer_notes(params),
            ...
            "workflow.configurationList" => self.list_workflow_configurations(params),
