#!/usr/bin/env python3
"""
Regression test: `termloop claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="termloop-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `termloop claude-teams --help` exited non-zero")
    ...
    print("PASS: termloop claude-teams forwards --help to Claude")
    return 0
