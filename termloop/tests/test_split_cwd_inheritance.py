...
Requires:
  - termloop running with allowAll socket mode
  - bash shell integration sourced (termloop-bash-integration.bash)

Run with a tagged instance:
  TERMLOOP_TAG=<tag> python3 tests/test_split_cwd_inheritance.py
"""
...
from termloop import termloop  # noqa: E402
