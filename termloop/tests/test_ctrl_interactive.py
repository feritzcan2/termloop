#!/usr/bin/env python3
"""
Interactive test for Ctrl+C and Ctrl+D in termloop terminal.

This script tests that control signals are properly handled.
Run this script inside the termloop terminal.
...
def main():
    ...
    print("Run this inside the termloop terminal to verify the fix.\n")
