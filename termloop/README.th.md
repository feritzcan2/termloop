...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="ดาวน์โหลด TermLoop สำหรับ macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="ภาพหน้าจอ TermLoop" width="900" />
</p>

<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ วิดีโอสาธิต</a> · <a href="https://termloop.ai/blog/zen-of-cmux">The Zen of TermLoop</a>
</p>
...
- **คำสั่งที่กำหนดเอง** — กำหนดการทำงานเฉพาะโปรเจกต์ใน [`cmux.json`](https://termloop.ai/docs/custom-commands) ที่เรียกใช้ได้จากพาเลตคำสั่ง
...
เปิดไฟล์ `.dmg` แล้วลาก TermLoop ไปยังโฟลเดอร์แอปพลิเคชัน TermLoop อัปเดตอัตโนมัติผ่าน Sparkle คุณจึงต้องดาวน์โหลดเพียงครั้งเดียว
...
ผมลองใช้ออร์เคสเตรเตอร์สำหรับเขียนโค้ดบางตัว แต่ส่วนใหญ่เป็นแอป Electron/Tauri และประสิทธิภาพทำให้ผมรำคาญ ผมยังชอบเทอร์มินัลมากกว่าเพราะออร์เคสเตรเตอร์ GUI บังคับให้คุณใช้เวิร์กโฟลว์ของมัน ผมจึงสร้าง TermLoop เป็นแอป macOS ดั้งเดิมด้วย Swift/AppKit มันใช้ libghostty สำหรับการแสดงผลเทอร์มินัลและอ่านการตั้งค่า Ghostty ที่มีอยู่ของคุณสำหรับธีม ฟอนต์ และสี
...
TermLoop ไม่ได้กำหนดว่านักพัฒนาต้องใช้เครื่องมืออย่างไร มันเป็นเทอร์มินัลและเบราว์เซอร์พร้อม CLI ส่วนที่เหลือขึ้นอยู่กับคุณ

TermLoop เป็นส่วนประกอบพื้นฐาน ไม่ใช่โซลูชันสำเร็จรูป มันให้เทอร์มินัล เบราว์เซอร์ การแจ้งเตือน เวิร์กสเปซ แผงแบ่ง แท็บ และ CLI เพื่อควบคุมทั้งหมด TermLoop ไม่บังคับให้คุณใช้เอเจนต์เขียนโค้ดในแบบที่มีความคิดเห็นตายตัว สิ่งที่คุณสร้างด้วยส่วนประกอบพื้นฐานเหล่านี้เป็นของคุณ
...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการตั้งค่า TermLoop, [ไปที่เอกสารของเรา](https://termloop.ai/docs/getting-started?utm_source=readme)
...
[ดาวน์โหลด TermLoop NIGHTLY](https://github.com/feritzcan2/termloop/releases/download/nightly/termloop-nightly-macos.dmg)

TermLoop NIGHTLY เป็นแอปแยกต่างหากที่มี bundle ID เป็นของตัวเอง จึงสามารถรันควบคู่กับเวอร์ชันเสถียรได้ สร้างอัตโนมัติจากคอมมิต `main` ล่าสุดและอัปเดตอัตโนมัติผ่านฟีด Sparkle ของตัวเอง

## การกู้คืนเซสชัน (พฤติกรรมปัจจุบัน)

เมื่อเปิดใหม่ TermLoop จะกู้คืนเลย์เอาต์และข้อมูลเมตาของแอปเท่านั้น:
- เลย์เอาต์หน้าต่าง/เวิร์กสเปซ/แผง
- ไดเรกทอรีทำงาน
- ประวัติการเลื่อนของเทอร์มินัล (พยายามอย่างดีที่สุด)
- URL ของเบราว์เซอร์และประวัติการนำทาง

TermLoop **ไม่**กู้คืนสถานะกระบวนการที่กำลังทำงานภายในแอปเทอร์มินัล ตัวอย่างเช่น เซสชัน Claude Code/tmux/vim ที่กำลังทำงานอยู่จะยังไม่ถูกกู้คืนหลังจากรีสตาร์ท
...
- เข้าร่วมสนทนาบน [Discord](https://github.com/feritzcan2/termloop/discussions)
- สร้างและมีส่วนร่วมใน [GitHub issues](https://github.com/feritzcan2/termloop/issues) และ [discussions](https://github.com/feritzcan2/termloop/discussions)
- แจ้งให้เรารู้ว่าคุณกำลังสร้างอะไรด้วย TermLoop
...
TermLoop เป็นซอฟต์แวร์ฟรี โอเพนซอร์ส และจะเป็นเช่นนั้นตลอดไป หากคุณต้องการสนับสนุนการพัฒนาและเข้าถึงสิ่งที่กำลังจะมาถึงก่อนใคร:

**[รับ Founder's Edition](https://buy.stripe.com/3cI00j2Ld0it5OU33r5EY0q)**

- **คำขอฟีเจอร์/แก้ไขบั๊กที่ได้รับความสำคัญ**
- **เข้าถึงก่อน: TermLoop AI ที่ให้บริบทเกี่ยวกับทุกเวิร์กสเปซ แท็บ และแผง**
...
TermLoop เป็นโอเพนซอร์สภายใต้ [GPL-3.0-or-later](LICENSE)

หากองค์กรของคุณไม่สามารถปฏิบัติตาม GPL ได้ มีสัญญาอนุญาตเชิงพาณิชย์ให้เลือกใช้ ติดต่อ [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) สำหรับรายละเอียด
