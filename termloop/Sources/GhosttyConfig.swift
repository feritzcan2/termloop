...
struct GhosttyConfig {
    ...
    private static let termloopReleaseBundleIdentifier = "com.termloop.app"
    ...
    private static func cmuxConfigPaths(
        ...
        let releasePaths = paths(for: termloopReleaseBundleIdentifier)
        guard let currentBundleIdentifier, !currentBundleIdentifier.isEmpty else {
            return releasePaths
        }
        if currentBundleIdentifier == termloopReleaseBundleIdentifier {
            return releasePaths
        }
