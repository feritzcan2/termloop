...
final class CmuxSettingsFileStore {
    ...
    static let schemaURLString = "https://raw.githubusercontent.com/feritzcan2/termloop/main/web/data/cmux-settings.schema.json"
    ...
    private static let backupsDefaultsKey = "termloop.settingsFile.backups.v1"
    ...
    static var defaultPrimaryPath: String {
        ...
        return (home as NSString).appendingPathComponent(".config/termloop/settings.json")
    }
    ...
    static func defaultTemplate() -> String {
        var lines: [String] = [
            ...
            "  // termloop creates this template on launch when both settings file locations are missing.",
            "  // ~/.config/termloop/settings.json takes precedence over the Application Support fallback.",
            "",
        ]
...
private final class ShortcutSettingsFileWatcher {
    ...
    private let watchQueue = DispatchQueue(label: "com.termloop.shortcut-settings-file-watch")
