...
enum UpdateSettings {
    ...
    static let migrationKey = "termloop.sparkle.automaticChecksMigration.v2"
...
/// Controller for managing Sparkle updates in TermLoop.
class UpdateController {
    ...
    func startUpdaterIfNeeded() {
        ...
        if ProcessInfo.processInfo.environment["TERMLOOP_UI_TEST_RESET_SPARKLE_PERMISSION"] == "1" {
            let defaults = UserDefaults.standard
    ...
    private func recordUITestTimestamp(key: String) {
        ...
        guard let path = env["TERMLOOP_UI_TEST_TIMING_PATH"] else { return }
