...
class UpdateDriver: NSObject, SPUUserDriver {
    ...
    func show(_ request: SPUUpdatePermissionRequest,
        ...
        if env["TERMLOOP_UI_TEST_TRIGGER_UPDATE_CHECK"] == "1" || env["TERMLOOP_UI_TEST_AUTO_ALLOW_PERMISSION"] == "1" {
...
#endif
        // Never show Sparkle's permission UI. termloop always enables scheduled checks and keeps
    ...
    func showUpdateReleaseNotes(with downloadData: SPUDownloadData) {
        // termloop uses Sparkle's UI for release notes links instead.
    }
    ...
    func showUpdateInFocus() {
        // No-op; termloop never shows Sparkle dialogs.
    }
