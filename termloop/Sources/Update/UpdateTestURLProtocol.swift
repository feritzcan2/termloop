...
final class UpdateTestURLProtocol: URLProtocol {
    static let host = "termloop.test"
    static let appcastPath = "/appcast.xml"
    static let updatePath = "/termloop-test.zip"
    ...
    private static func appcastData() -> Data {
        ...
        let mode = env["TERMLOOP_UI_TEST_FEED_MODE"] ?? "available"
        ...
        <rss version="2.0"
          ...
          <channel>
            <title>termloop Test Updates</title>
    ...
    private static func updateArchiveData() -> Data {
        Data("termloop test update".utf8)
    }
}
#endif
