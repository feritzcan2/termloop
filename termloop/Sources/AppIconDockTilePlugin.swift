...
private let termloopAppIconDidChangeNotification = Notification.Name("com.termloop.appIconDidChange")
...
final class TermLoopDockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    private let pluginBundle = Bundle(for: TermLoopDockTilePlugin.self)
    ...
    func setDockTile(_ dockTile: NSDockTile?) {
        ...
        iconChangeObserver = DistributedNotificationCenter.default().addObserver(
            forName: termloopAppIconDidChangeNotification,
            object: nil,
            queue: nil
        ) { [weak self] _ in
