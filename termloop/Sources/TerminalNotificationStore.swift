...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.termloop.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let stagedCustomSoundBaseName = "termloop-custom-notification-sound"
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.termloop.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.termloop.notification-custom-command",
        qos: .utility
    )
    ...
    static func runCustomCommand(title: String, subtitle: String, body: String, defaults: UserDefaults = .standard) {
        ...
        customCommandQueue.async {
            ...
            env["TERMLOOP_NOTIFICATION_TITLE"] = title
            env["TERMLOOP_NOTIFICATION_SUBTITLE"] = subtitle
            env["TERMLOOP_NOTIFICATION_BODY"] = body
...
enum TaggedRunBadgeSettings {
    static let environmentKey = "TERMLOOP_TAG"
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.termloop.app.userNotification"
    static let actionShowIdentifier = "com.termloop.app.userNotification.show"
    ...
    func sendSettingsTestNotification() {
        ...
        ensureAuthorization(origin: .settingsTest) { [weak self] authorized in
            ...
            let request = UNNotificationRequest(
                identifier: "termloop.settings.test.\(UUID().uuidString)",
                content: content,
                trigger: nil
            )
    ...
    private func presentNotificationSettingsPrompt(attempt: Int) {
        ...
        alert.messageText = String(localized: "dialog.enableNotifications.title", defaultValue: "Enable Notifications for TermLoop")
        alert.informativeText = String(localized: "dialog.enableNotifications.message", defaultValue: "Notifications are disabled for TermLoop. Enable them in System Settings to see alerts.")
