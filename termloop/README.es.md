...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="Descargar TermLoop para macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="Captura de pantalla de TermLoop" width="900" />
</p>

<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ Video de demostración</a> · <a href="https://termloop.ai/blog/zen-of-cmux">The Zen of TermLoop</a>
</p>
...
- **Comandos personalizados** — Define acciones específicas del proyecto en [`cmux.json`](https://termloop.ai/docs/custom-commands) que se lanzan desde la paleta de comandos
...
Abre el `.dmg` y arrastra TermLoop a tu carpeta de Aplicaciones. TermLoop se actualiza automáticamente a través de Sparkle, así que solo necesitas descargarlo una vez.
...
Probé algunos orquestadores de programación, pero la mayoría eran aplicaciones Electron/Tauri y el rendimiento me molestaba. Además, simplemente prefiero la terminal ya que los orquestadores con GUI te encierran en su flujo de trabajo. Así que construí TermLoop como una app nativa de macOS en Swift/AppKit. Usa libghostty para el renderizado del terminal y lee tu configuración existente de Ghostty para temas, fuentes y colores.
...
TermLoop no prescribe cómo los desarrolladores deben usar sus herramientas. Es un terminal y navegador con un CLI, y el resto depende de ti.

TermLoop es un primitivo, no una solución. Te da un terminal, un navegador, notificaciones, espacios de trabajo, divisiones, pestañas y un CLI para controlarlo todo. TermLoop no te obliga a usar los agentes de programación de una manera específica. Lo que construyas con los primitivos es tuyo.
...
Para más información sobre cómo configurar TermLoop, [visita nuestra documentación](https://termloop.ai/docs/getting-started?utm_source=readme).
...
[Descargar TermLoop NIGHTLY](https://github.com/feritzcan2/termloop/releases/download/nightly/termloop-nightly-macos.dmg)

TermLoop NIGHTLY es una app separada con su propio bundle ID, por lo que se ejecuta junto a la versión estable. Se compila automáticamente desde el último commit de `main` y se actualiza automáticamente a través de su propio feed de Sparkle.

## Restauración de sesión (comportamiento actual)

Al relanzar, TermLoop actualmente restaura solo el diseño y los metadatos de la aplicación:
...
TermLoop **no** restaura el estado de los procesos activos dentro de las aplicaciones de terminal. Por ejemplo, las sesiones activas de Claude Code/tmux/vim no se reanudan después de reiniciar todavía.
...
- Únete a la conversación en [Discord](https://github.com/feritzcan2/termloop/discussions)
- Crea y participa en [GitHub issues](https://github.com/feritzcan2/termloop/issues) y [discusiones](https://github.com/feritzcan2/termloop/discussions)
- Cuéntanos qué estás construyendo con TermLoop
...
TermLoop es gratuito, de código abierto, y siempre lo será. Si deseas apoyar el desarrollo y obtener acceso anticipado a lo que viene:
...
- **Acceso anticipado: TermLoop AI que te da contexto sobre cada espacio de trabajo, pestaña y panel**
...
TermLoop es código abierto bajo [GPL-3.0-or-later](LICENSE).

Si su organización no puede cumplir con GPL, hay una licencia comercial disponible. Contacte a [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) para más detalles.
