...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="Preuzmi TermLoop za macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="TermLoop snimak ekrana" width="900" />
</p>
...
- **Prilagođene komande** — Definirajte akcije specifične za projekt u [`cmux.json`](https://termloop.ai/docs/custom-commands) koje se pokreću iz palete komandi
...
Otvorite `.dmg` datoteku i prevucite TermLoop u folder Aplikacije. TermLoop se automatski ažurira putem Sparkle, tako da trebate preuzeti samo jednom.
...
Isprobao sam nekoliko orkestratora za kodiranje, ali većina ih je bila Electron/Tauri aplikacije i performanse su me nervirale. Također jednostavno preferiram terminal jer GUI orkestratori vas zaključavaju u svoj radni tok. Zato sam izgradio TermLoop kao nativnu macOS aplikaciju u Swift/AppKit. Koristi libghostty za renderiranje terminala i čita vašu postojeću Ghostty konfiguraciju za teme, fontove i boje.
...
TermLoop ne propisuje programerima kako da koriste svoje alate. To je terminal i preglednik sa CLI-jem, a ostatak je na vama.

TermLoop je primitiv, ne rješenje. Daje vam terminal, preglednik, obavještenja, radne prostore, podjele, tabove i CLI za kontrolu svega toga. TermLoop vas ne prisiljava na određeni način korištenja agenata za kodiranje. Ono što izgradite sa tim primitivima je vaše.
...
Za više informacija o konfiguraciji TermLoop, posjetite [našu dokumentaciju](https://termloop.ai/docs/getting-started?utm_source=readme).
...
[Preuzmi TermLoop NIGHTLY](https://github.com/feritzcan2/termloop/releases/download/nightly/termloop-nightly-macos.dmg)

TermLoop NIGHTLY je zasebna aplikacija sa vlastitim bundle ID-om, tako da radi uporedo sa stabilnom verzijom. Automatski se gradi iz najnovijeg `main` commita i ažurira se putem vlastitog Sparkle feeda.

## Vraćanje sesije (trenutno ponašanje)

Prilikom ponovnog pokretanja, TermLoop trenutno vraća samo raspored aplikacije i metapodatke:
- Raspored prozora/radnih prostora/panela
- Radne direktorije
- Scrollback terminala (po mogućnosti)
- URL preglednika i historija navigacije

TermLoop **ne** vraća stanje živih procesa unutar terminalnih aplikacija. Na primjer, aktivne sesije Claude Code/tmux/vim se još ne nastavljaju nakon restarta.
...
- Pridružite se razgovoru na [Discordu](https://github.com/feritzcan2/termloop/discussions)
- Kreirajte i učestvujte u [GitHub issues](https://github.com/feritzcan2/termloop/issues) i [diskusijama](https://github.com/feritzcan2/termloop/discussions)
- Javite nam šta gradite sa TermLoop
...
TermLoop je besplatan, otvorenog koda i uvijek će biti. Ako želite podržati razvoj i dobiti rani pristup onome što dolazi:

**[Nabavite Osnivačko izdanje](https://buy.stripe.com/3cI00j2Ld0it5OU33r5EY0q)**

- **Prioritetni zahtjevi za funkcije/ispravke grešaka**
- **Rani pristup: TermLoop AI koji vam daje kontekst o svakom radnom prostoru, tabu i panelu**
...
TermLoop je otvorenog koda pod [GPL-3.0-or-later](LICENSE) licencom.

Ako vaša organizacija ne može ispuniti uslove GPL-a, dostupna je komercijalna licenca. Kontaktirajte [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) za detalje.
