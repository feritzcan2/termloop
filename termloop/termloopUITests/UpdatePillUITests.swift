...
final class UpdatePillUITests: XCTestCase {
    ...
    func testUpdatePillShowsForAvailableUpdate() {
        ...
        app.launchEnvironment["TERMLOOP_UI_TEST_UPDATE_STATE"] = "available"
    ...
    func testDetectedBackgroundUpdateShowsPillWithoutManualCheck() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["TERMLOOP_UI_TEST_MODE"] = "1"
        app.launchEnvironment["TERMLOOP_UI_TEST_DETECTED_UPDATE_VERSION"] = "9.9.9"
        launchAndActivate(app)
    ...
    func testDetectedBackgroundUpdateFirstClickOpensPopover() {
        ...
        app.launchEnvironment["TERMLOOP_UI_TEST_FEED_MODE"] = "none"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsForNoUpdateThenDismisses() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["TERMLOOP_UI_TEST_MODE"] = "1"
        app.launchEnvironment["TERMLOOP_UI_TEST_UPDATE_STATE"] = "notFound"
        app.launchEnvironment["TERMLOOP_UI_TEST_TIMING_PATH"] = timingPath.path
        launchAndActivate(app)
    ...
    func testCheckForUpdatesShowsLoadingThenNoUpdateInSidebarFooter() {
        ...
        let app = launchAppWithMockFeed(
            ...
            version: "9.9.9",
            extraEnvironment: [
                "TERMLOOP_UI_TEST_MOCK_FEED_DELAY_MS": "7000",
            ]
        )
    ...
    func testNoSparklePermissionDialogIsShown() {
        ...
        app.launchEnvironment["TERMLOOP_UI_TEST_RESET_SPARKLE_PERMISSION"] = "1"
        launchAndActivate(app)
    ...
    private func launchAppWithMockFeed(
        ...
        app.launchEnvironment["TERMLOOP_UI_TEST_MODE"] = "1"
        app.launchEnvironment["TERMLOOP_UI_TEST_FEED_URL"] = "https://cmux.test/appcast.xml"
        app.launchEnvironment["TERMLOOP_UI_TEST_FEED_MODE"] = mode
        app.launchEnvironment["TERMLOOP_UI_TEST_UPDATE_VERSION"] = version
        app.launchEnvironment["TERMLOOP_UI_TEST_AUTO_ALLOW_PERMISSION"] = "1"
        app.launchEnvironment["TERMLOOP_UI_TEST_TRIGGER_UPDATE_CHECK"] = "1"
        if let timingPath {
            app.launchEnvironment["TERMLOOP_UI_TEST_TIMING_PATH"] = timingPath.path
        }
