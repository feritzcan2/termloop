...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="Download TermLoop til macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="TermLoop skærmbillede" width="900" />
</p>
...
- **Brugerdefinerede kommandoer** — Definér projektspecifikke handlinger i [`cmux.json`](https://termloop.ai/docs/custom-commands), der startes fra kommandopaletten
...
Åbn `.dmg`-filen og træk TermLoop til din Programmer-mappe. TermLoop opdaterer sig selv automatisk via Sparkle, så du behøver kun at downloade én gang.
...
Jeg prøvede et par kodningsorkestratore, men de fleste var Electron/Tauri-apps, og ydelsen irriterede mig. Jeg foretrækker også bare terminalen, da GUI-orkestratore låser dig ind i deres arbejdsgang. Så jeg byggede TermLoop som en nativ macOS-app i Swift/AppKit. Den bruger libghostty til terminal-rendering og læser din eksisterende Ghostty-konfiguration til temaer, skrifttyper og farver.
...
TermLoop foreskriver ikke, hvordan udviklere bruger deres værktøjer. Det er en terminal og browser med en CLI, resten er op til dig.

TermLoop er en primitiv, ikke en løsning. Det giver dig en terminal, en browser, notifikationer, workspaces, opdelinger, faner og en CLI til at styre det hele. TermLoop tvinger dig ikke ind i en forudbestemt måde at bruge kodningsagenter på. Hvad du bygger med primitiverne, er dit eget.
...
For mere information om konfiguration af TermLoop, [se vores dokumentation](https://termloop.ai/docs/getting-started?utm_source=readme).
...
TermLoop NIGHTLY er en separat app med sit eget bundle-ID, så den kører side om side med den stabile version. Bygges automatisk fra det seneste `main`-commit og opdaterer sig selv automatisk via sit eget Sparkle-feed.

## Sessionsgenoprettelse (nuværende adfærd)

Ved genstart genopretter TermLoop i øjeblikket kun app-layout og metadata:
- Vindue/workspace/panel-layout
- Arbejdsmapper
- Terminal-scrollback (best effort)
- Browser-URL og navigationshistorik

TermLoop genopretter **ikke** aktive procestilstande i terminalapps. For eksempel genoptages aktive Claude Code/tmux/vim-sessioner endnu ikke efter genstart.
...
- Deltag i samtalen på [Discord](https://github.com/feritzcan2/termloop/discussions)
- Opret og deltag i [GitHub issues](https://github.com/feritzcan2/termloop/issues) og [diskussioner](https://github.com/feritzcan2/termloop/discussions)
- Fortæl os, hvad du bygger med TermLoop
...
TermLoop er gratis, open source og vil altid være det. Hvis du gerne vil støtte udviklingen og få tidlig adgang til det, der kommer:

**[Få Founder's Edition](https://buy.stripe.com/3cI00j2Ld0it5OU33r5EY0q)**

- **Prioriterede funktionsønsker og fejlrettelser**
- **Tidlig adgang: TermLoop AI der giver dig kontekst om hvert workspace, fane og panel**
...
TermLoop er open source under [GPL-3.0-or-later](LICENSE).

Hvis din organisation ikke kan overholde GPL, er en kommerciel licens tilgængelig. Kontakt [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) for detaljer.
