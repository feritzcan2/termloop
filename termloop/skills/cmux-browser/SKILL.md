---
name: cmux-browser
description: End-user browser automation with cmux. Use when you need to open sites, interact with pages, wait for state changes, and extract data from termloop browser surfaces.
---

# Browser Automation with cmux

Use this skill for browser tasks inside termloop webviews.
