...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="macOS için TermLoop'u indir" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="TermLoop ekran görüntüsü" width="900" />
</p>

<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ Demo videosu</a> · <a href="https://termloop.ai/blog/zen-of-cmux">The Zen of TermLoop</a>
</p>
...
- **Özel komutlar** — Komut paletinden başlatılan projeye özel eylemleri [`cmux.json`](https://termloop.ai/docs/custom-commands) dosyasında tanımlayın
...
`.dmg` dosyasını açın ve TermLoop'u Uygulamalar klasörüne sürükleyin. TermLoop Sparkle aracılığıyla otomatik güncellenir, bu yüzden yalnızca bir kez indirmeniz yeterlidir.
...
Birkaç kodlama orkestratörü denedim ama çoğu Electron/Tauri uygulamasıydı ve performansları beni rahatsız ediyordu. Ayrıca terminali tercih ediyorum çünkü GUI orkestratörleri sizi kendi iş akışlarına kilitliyor. Bu yüzden TermLoop'u Swift/AppKit'te yerel bir macOS uygulaması olarak geliştirdim. Terminal görüntüleme için libghostty kullanıyor ve temalar, yazı tipleri ve renkler için mevcut Ghostty yapılandırmanızı okuyor.
...
TermLoop, geliştiricilerin araçlarını nasıl kullandığını dikte etmez. Bir terminal ve tarayıcı ile CLI'dir, geri kalanı size kalmış.

TermLoop bir ilkel yapıdır, hazır bir çözüm değil. Size bir terminal, bir tarayıcı, bildirimler, çalışma alanları, bölmeler, sekmeler ve hepsini kontrol etmek için bir CLI verir. TermLoop sizi kodlama ajanlarını belirli bir şekilde kullanmaya zorlamaz. İlkel yapılarla ne inşa edeceğiniz tamamen size aittir.
...
TermLoop'u nasıl yapılandıracağınız hakkında daha fazla bilgi için, [dokümantasyonumuza gidin](https://termloop.ai/docs/getting-started?utm_source=readme).
...
[TermLoop NIGHTLY'i indir](https://github.com/feritzcan2/termloop/releases/download/nightly/termloop-nightly-macos.dmg)

TermLoop NIGHTLY, kendi bundle ID'sine sahip ayrı bir uygulamadır, bu yüzden kararlı sürümle yan yana çalışır. En son `main` commit'inden otomatik olarak derlenir ve kendi Sparkle akışı aracılığıyla otomatik güncellenir.

## Oturum geri yükleme (mevcut davranış)

Yeniden başlatıldığında, TermLoop şu anda yalnızca uygulama düzenini ve meta verileri geri yükler:
- Pencere/çalışma alanı/panel düzeni
- Çalışma dizinleri
- Terminal kaydırma geçmişi (en iyi çaba)
- Tarayıcı URL'si ve gezinme geçmişi

TermLoop, terminal uygulamaları içindeki canlı işlem durumunu geri **yüklemez**. Örneğin, aktif Claude Code/tmux/vim oturumları yeniden başlatma sonrasında henüz devam ettirilmez.
...
- [Discord](https://github.com/feritzcan2/termloop/discussions)'da sohbete katılın
- [GitHub issues](https://github.com/feritzcan2/termloop/issues) ve [discussions](https://github.com/feritzcan2/termloop/discussions) oluşturun ve katılın
- TermLoop ile ne inşa ettiğinizi bize bildirin
...
TermLoop ücretsiz, açık kaynak ve her zaman öyle olacak. Geliştirmeyi desteklemek ve sırada ne olduğuna erken erişim almak isterseniz:

**[Founder's Edition'ı Edinin](https://buy.stripe.com/3cI00j2Ld0it5OU33r5EY0q)**

- **Öncelikli özellik istekleri/hata düzeltmeleri**
- **Erken erişim: Her çalışma alanı, sekme ve panel hakkında bağlam sağlayan TermLoop AI**
...
TermLoop, [GPL-3.0-or-later](LICENSE) kapsamında açık kaynaklıdır.

Kuruluşunuz GPL'ye uyum sağlayamıyorsa, ticari lisans mevcuttur. Ayrıntılar için [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) ile iletişime geçin.
