...
export const shortcutCategories: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { id: "reloadConfiguration", combos: [["⌘", "⇧", ","]], description: { en: "Reload configuration", ja: "構成を再読み込み" } },
      {
        ...
        combos: [["⌃", "⌥", "⌘", "."]],
        description: { en: "Show/hide all termloop windows", ja: "すべてのcmuxウインドウを表示/非表示" },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "selectProjectByNumber", combos: [["⇧", "1…9"]], description: { en: "Select project 1…9", ja: "プロジェクト1…9を選択" } },
