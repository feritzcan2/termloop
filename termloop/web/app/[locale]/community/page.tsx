    ...
    <div className="min-h-screen">
      ...
      <main className="w-full max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <CommunityLink
            href="https://github.com/feritzcan2/termloop/discussions"
            name={t("discussions")}
            action={t("discussionsAction")}
          ...
          <CommunityLink
            href="https://github.com/feritzcan2/termloop"
            name="GitHub"
          ...
          <CommunityLink
            href="https://github.com/feritzcan2/termloop"
            name={t("repository")}
            action={t("repositoryAction")}
            description={t("repositoryDesc")}
            icon={
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
