...
const schemaUrl =
  ...
  "https://raw.githubusercontent.com/feritzcan2/termloop/main/web/data/cmux-settings.schema.json";
const schemaSourceUrl =
  "https://github.com/feritzcan2/termloop/blob/main/web/data/cmux-settings.schema.json";
const sectionOrder = [
  "app",
  "notifications",
  "sidebar",
...
working-directory = ~/code`}</CodeBlock>
      ...
      <p>
        ...
        <code>~/.config/termloop/settings.json</code>.
      </p>
      <ol>
        <li>
          <code>~/.config/termloop/settings.json</code>
        ...
        <li>
          <code>~/Library/Application Support/com.termloop.app/settings.json</code>
        </li>
      </ol>
      <Callout type="info">
        <strong>Precedence:</strong> <code>~/.config/termloop/settings.json</code> wins over the
      ...
      <Callout type="warn">
        ...
        Future termloop versions will use that field for upgrades. If termloop sees a newer schema version,
      ...
      <CodeBlock title="~/.config/termloop/settings.json" lang="json">
        {settingsFileExample}
      </CodeBlock>
