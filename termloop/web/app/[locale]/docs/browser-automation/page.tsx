...
cmux browser surface:2 fill "#email" --text "feritzcan93@gmail.com"
...
cmux browser surface:2 screenshot --out /tmp/termloop-page.png
...
cmux browser surface:2 state save /tmp/termloop-browser-state.json
cmux browser surface:2 state load /tmp/termloop-browser-state.json`}</CodeBlock>
...
cmux browser surface:2 get title`}</CodeBlock>
      ...
      <h3>{t("patternForm")}</h3>
      <CodeBlock lang="bash">{`cmux browser surface:2 fill "#email" --text "feritzcan93@gmail.com"
...
cmux browser surface:2 is visible "#dashboard"`}</CodeBlock>
      ...
      <CodeBlock lang="bash">{`cmux browser surface:2 console list
cmux browser surface:2 errors list
cmux browser surface:2 screenshot --out /tmp/termloop-failure.png
