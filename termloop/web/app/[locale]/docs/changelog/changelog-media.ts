  ...
  "0.61.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Hit Cmd+Shift+P to open a searchable command palette. Every action in termloop is here: creating workspaces, toggling the sidebar, checking for updates, switching windows. Keyboard shortcuts are shown inline so you can learn them as you go.",
