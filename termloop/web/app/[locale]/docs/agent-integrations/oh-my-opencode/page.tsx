...
export default function OhMyOpenCodePage() {
  ...
  return (
    <>
      ...
      <h2>{t("usage")}</h2>
      <CodeBlock lang="bash">{`termloop omo
termloop omo --continue
termloop omo --model claude-sonnet-4-6`}</CodeBlock>
      <p>{t("usageDesc")}</p>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>~/.termloop/omo-bin/</code></td><td>{t("dirShim")}</td></tr>
          <tr><td><code>~/.termloop/omo-config/</code></td><td>{t("dirShadow")}</td></tr>
          <tr><td><code>~/.termloop/tmux-compat-store.json</code></td><td>{t("dirStore")}</td></tr>
        </tbody>
      </table>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>TERMLOOP_SOCKET_PATH</code></td><td>{t("envSocket")}</td></tr>
        </tbody>
      </table>
    </>
  );
