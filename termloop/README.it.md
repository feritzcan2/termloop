...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="Scarica TermLoop per macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="Screenshot di TermLoop" width="900" />
</p>

<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ Video demo</a> · <a href="https://termloop.ai/blog/zen-of-cmux">The Zen of TermLoop</a>
</p>
...
- **Comandi personalizzati** — Definisci azioni specifiche per il progetto in [`cmux.json`](https://termloop.ai/docs/custom-commands) che si lanciano dalla palette dei comandi
...
Apri il file `.dmg` e trascina TermLoop nella cartella Applicazioni. TermLoop si aggiorna automaticamente tramite Sparkle, quindi devi scaricarlo solo una volta.
...
TermLoop non prescrive come gli sviluppatori usano i propri strumenti. È un terminale e un browser con un CLI, il resto dipende da te.

TermLoop è una primitiva, non una soluzione. Ti dà un terminale, un browser, notifiche, workspace, divisioni, schede e un CLI per controllare tutto. TermLoop non ti obbliga a usare gli agenti di programmazione in un modo predefinito. Quello che costruisci con le primitive è tuo.
...
Per maggiori informazioni su come configurare TermLoop, [consulta la nostra documentazione](https://termloop.ai/docs/getting-started?utm_source=readme).
...
[Scarica TermLoop NIGHTLY](https://github.com/feritzcan2/termloop/releases/download/nightly/termloop-nightly-macos.dmg)

TermLoop NIGHTLY è un'app separata con il proprio bundle ID, quindi funziona in parallelo alla versione stabile. Compilata automaticamente dall'ultimo commit `main` e aggiornata automaticamente tramite il proprio feed Sparkle.

## Ripristino sessione (comportamento attuale)

Al riavvio, TermLoop attualmente ripristina solo il layout e i metadati dell'applicazione:
- Layout di finestre/workspace/pannelli
- Directory di lavoro
- Scrollback del terminale (best effort)
- URL del browser e cronologia di navigazione

TermLoop **non** ripristina lo stato dei processi attivi nelle applicazioni del terminale. Per esempio, le sessioni attive di Claude Code/tmux/vim non vengono ancora riprese dopo un riavvio.
...
- Unisciti alla conversazione su [Discord](https://github.com/feritzcan2/termloop/discussions)
- Crea e partecipa alle [issue su GitHub](https://github.com/feritzcan2/termloop/issues) e alle [discussioni](https://github.com/feritzcan2/termloop/discussions)
- Facci sapere cosa stai costruendo con TermLoop
...
TermLoop è gratuito, open source, e lo sarà sempre. Se vuoi supportare lo sviluppo e ottenere accesso anticipato a ciò che arriverà:
...
- **Accesso anticipato: TermLoop AI che ti dà contesto su ogni workspace, scheda e pannello**
...
TermLoop è open source sotto [GPL-3.0-or-later](LICENSE).

Se la tua organizzazione non può conformarsi alla GPL, è disponibile una licenza commerciale. Contatta [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) per i dettagli.
