...
<p align="center">
  <a href="https://github.com/feritzcan2/termloop/releases/latest/download/termloop-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="TermLoop für macOS herunterladen" width="180" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ Demo-Video</a> · <a href="https://termloop.ai/blog/zen-of-cmux">The Zen of TermLoop</a>
</p>
...
- **Benutzerdefinierte Befehle** — Definieren Sie projektspezifische Aktionen in [`cmux.json`](https://termloop.ai/docs/custom-commands), die über die Befehlspalette gestartet werden
...
Öffnen Sie die `.dmg`-Datei und ziehen Sie TermLoop in Ihren Programme-Ordner. TermLoop aktualisiert sich automatisch über Sparkle, sodass Sie nur einmal herunterladen müssen.
...
Ich habe einige Coding-Orchestratoren ausprobiert, aber die meisten waren Electron/Tauri-Apps und die Performance hat mich gestört. Ich bevorzuge außerdem das Terminal, da GUI-Orchestratoren einen in ihren Workflow einschließen. Also habe ich TermLoop als native macOS-App in Swift/AppKit gebaut. Es verwendet libghostty für das Terminal-Rendering und liest Ihre vorhandene Ghostty-Konfiguration für Themes, Schriftarten und Farben.
...
TermLoop schreibt Entwicklern nicht vor, wie sie ihre Werkzeuge nutzen sollen. Es ist ein Terminal und Browser mit einer CLI, und der Rest liegt bei Ihnen.

TermLoop ist ein Grundbaustein, keine fertige Lösung. Es bietet Ihnen ein Terminal, einen Browser, Benachrichtigungen, Arbeitsbereiche, Teilungen, Tabs und eine CLI, um alles zu steuern. TermLoop zwingt Sie nicht in eine bestimmte Art, Coding-Agenten zu nutzen. Was Sie mit den Grundbausteinen bauen, ist Ihre Sache.
...
Weitere Informationen zur Konfiguration von TermLoop finden Sie in [unserer Dokumentation](https://termloop.ai/docs/getting-started?utm_source=readme).
...
[TermLoop NIGHTLY herunterladen](https://github.com/feritzcan2/termloop/releases/download/nightly/termloop-nightly-macos.dmg)

TermLoop NIGHTLY ist eine separate App mit eigener Bundle-ID, die neben der stabilen Version läuft. Wird automatisch vom neuesten `main`-Commit gebaut und aktualisiert sich über einen eigenen Sparkle-Feed.

## Sitzungswiederherstellung (aktuelles Verhalten)

Beim Neustart stellt TermLoop derzeit nur App-Layout und Metadaten wieder her:
- Fenster-/Arbeitsbereich-/Bereichs-Layout
- Arbeitsverzeichnisse
- Terminal-Scrollback (bestmöglich)
- Browser-URL und Navigationsverlauf

TermLoop stellt **keine** laufenden Prozesse in Terminal-Apps wieder her. Zum Beispiel werden aktive Claude Code-/tmux-/vim-Sitzungen nach einem Neustart noch nicht fortgesetzt.
...
- Nehmen Sie an der Diskussion auf [Discord](https://github.com/feritzcan2/termloop/discussions) teil
- Erstellen Sie [GitHub Issues](https://github.com/feritzcan2/termloop/issues) und beteiligen Sie sich an [Diskussionen](https://github.com/feritzcan2/termloop/discussions)
- Lassen Sie uns wissen, was Sie mit TermLoop bauen
...
TermLoop ist kostenlos, Open Source und wird es immer sein. Wenn Sie die Entwicklung unterstützen und frühen Zugang zu kommenden Funktionen erhalten möchten:

**[Founder's Edition erhalten](https://buy.stripe.com/3cI00j2Ld0it5OU33r5EY0q)**

- **Priorisierte Feature-Requests/Bugfixes**
- **Früher Zugang: TermLoop AI, das Ihnen Kontext zu jedem Arbeitsbereich, Tab und Panel gibt**
...
TermLoop ist Open Source unter [GPL-3.0-or-later](LICENSE).

Wenn Ihre Organisation GPL nicht einhalten kann, ist eine kommerzielle Lizenz verfügbar. Kontaktieren Sie [feritzcan93@gmail.com](mailto:feritzcan93@gmail.com) für Details.
