...
LOG_PATH_OVERRIDE = os.environ.get("TERMLOOP_DEBUG_LOG")
ITERATIONS = int(os.environ.get("TERMLOOP_PORTAL_ORPHAN_ITERS", "16"))
PANE_TIMEOUT_S = float(os.environ.get("TERMLOOP_PORTAL_ORPHAN_PANE_TIMEOUT_S", "3.0"))
INTEGRITY_TIMEOUT_S = float(os.environ.get("TERMLOOP_PORTAL_ORPHAN_INTEGRITY_TIMEOUT_S", "1.5"))
POLL_S = float(os.environ.get("TERMLOOP_PORTAL_ORPHAN_POLL_S", "0.02"))
CTRL_D_RETRY_INTERVAL_S = float(os.environ.get("TERMLOOP_PORTAL_ORPHAN_CTRL_D_RETRY_INTERVAL_S", "0.20"))
CTRL_D_MAX_EXTRA = int(os.environ.get("TERMLOOP_PORTAL_ORPHAN_CTRL_D_MAX_EXTRA", "3"))
POST_CLOSE_SETTLE_S = float(os.environ.get("TERMLOOP_PORTAL_ORPHAN_POST_CLOSE_SETTLE_S", "0.08"))
LOG_FLUSH_S = float(os.environ.get("TERMLOOP_PORTAL_ORPHAN_LOG_FLUSH_S", "0.15"))
...
def _derive_log_path(socket_path: str) -> str:
    ...
    if base.startswith("cmux-debug-") and base.endswith(".sock"):
        ...
        return f"/tmp/termloop-debug-{slug}.log"
