...
Environment:
  TERMLOOP_SOCKET or TERMLOOP_SOCKET_PATH can override the socket path.
"""
...
SOCKET_PATH = os.environ.get("TERMLOOP_SOCKET") or os.environ.get("TERMLOOP_SOCKET_PATH") or "/tmp/termloop-debug.sock"
