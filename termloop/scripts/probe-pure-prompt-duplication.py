...
Run this from a spare termloop pane. The script creates a temporary workspace,
...
def main() -> int:
    ...
    parser.add_argument(
        "--socket",
        default=os.environ.get("TERMLOOP_SOCKET") or os.environ.get("TERMLOOP_SOCKET_PATH") or "/tmp/termloop-debug.sock",
    )
