...
final class FinderServicePathResolverTests: XCTestCase {
    ...
    func testOrderedUniqueDirectoriesUsesParentForFilesAndDedupes() {
        let input: [URL] = [
            URL(fileURLWithPath: "/tmp/termloop-services/project", isDirectory: true),
            URL(fileURLWithPath: "/tmp/termloop-services/project/README.md", isDirectory: false),
            URL(fileURLWithPath: "/tmp/termloop-services/../cmux-services/project", isDirectory: true),
            URL(fileURLWithPath: "/tmp/termloop-services/other", isDirectory: true),
        ]
        ...
        XCTAssertEqual(
            directories,
            [
                "/tmp/termloop-services/project",
                "/tmp/termloop-services/other",
            ]
        )
    }
    ...
    func testOrderedUniqueDirectoriesPreservesFirstSeenOrder() {
        let input: [URL] = [
            URL(fileURLWithPath: "/tmp/termloop-services/b", isDirectory: true),
            URL(fileURLWithPath: "/tmp/termloop-services/a/file.txt", isDirectory: false),
            URL(fileURLWithPath: "/tmp/termloop-services/a", isDirectory: true),
            URL(fileURLWithPath: "/tmp/termloop-services/b/file.txt", isDirectory: false),
        ]
        ...
        XCTAssertEqual(
            directories,
            [
                "/tmp/termloop-services/b",
                "/tmp/termloop-services/a",
            ]
        )
    }
    ...
    func testOrderedUniqueDirectoriesSkipsBundleAndEmbeddedPathsWhenExcludingBundleRoot() {
        ...
        let input: [URL] = [
            bundleURL,
            URL(fileURLWithPath: "/Applications/TermLoop.app/Contents/MacOS/cmux", isDirectory: false),
            URL(fileURLWithPath: "/Applications/TermLoop.app/Contents/Resources/bin/termloop", isDirectory: false),
            URL(fileURLWithPath: "/Users/tester/Projects/cmux", isDirectory: true),
            URL(fileURLWithPath: "/Users/tester/Projects/termloop/README.md", isDirectory: false),
        ]
    ...
    func testOrderedUniqueDirectoriesExclusionDoesNotFilterSiblingPaths() {
        let bundleURL = URL(fileURLWithPath: "/Applications/TermLoop.app", isDirectory: true)
        let input: [URL] = [
            URL(fileURLWithPath: "/Applications/TermLoop.app backup/project", isDirectory: true),
            URL(fileURLWithPath: "/Applications/TermLoop.app.beta/project/file.txt", isDirectory: false),
        ]
        ...
        XCTAssertEqual(
            directories,
            [
                "/Applications/TermLoop.app backup/project",
                "/Applications/TermLoop.app.beta/project",
            ]
        )
    }
        ...
        try withTemporaryDirectory { root in
            ...
            let directories = FinderServicePathResolver.orderedUniqueDirectories(
                from: [
                    ...
                    aliasApplications.appendingPathComponent("TermLoop.app/Contents/MacOS/TermLoop", isDirectory: false),
                    aliasWorkspace,
                ],
