...
final class CmuxCLIPathInstallerTests: XCTestCase {
    func testInstallAndUninstallRoundTripWithoutAdministratorPrivileges() throws {
        ...
        let bundledCLIURL = root
            .appendingPathComponent("TermLoop.app/Contents/Resources/bin/termloop", isDirectory: false)
        ...
        let destinationURL = root.appendingPathComponent("usr/local/bin/termloop", isDirectory: false)
