import type { AgentStatus, BranchCommitSummary, ConnectionState, GitHostProjection, Project, ProjectWorktreeSummary, RunConfiguration, RunRuntime, Session, Task, WorkflowConfiguration } from "../model.js";
...
export class ProjectionStore {
  #state: ProjectionState = { projects: [], tasks: [], sessions: [], runConfigurations: [], workflowConfigurations: [], workflowStateRevision: 0, runRuntimes: [], runStateRevision: 0, processingTaskId: null, playbook: null, playbookRuntime: null, agentStatuses: [], gitHostProjections: [], branchCommitSummaries: [], connection: "connecting", errorLog: [] };
  ...
  applySelectedProjectSnapshot(projectId: string, tasks: Task[], gitHostProjections: GitHostProjection[] = [], branchCommitSummaries: BranchCommitSummary[] = [], projectWorktreeSummary?: ProjectWorktreeSummary, runConfigurations: RunConfiguration[] = [], runRuntimes: RunRuntime[] = [], runStateRevision = 0, processingTaskId: string | null = null, playbook: PlaybookDto | null = null, playbookRuntime: PlaybookRuntimeResult | null = null, workflowConfigurations: WorkflowConfiguration[] = [], workflowStateRevision = 0): void {
