...
import type { GhosttyBridge as SurfaceBridge } from "@termloop/terminal-surface/ghostty-bridge";
export type { GhosttyGrid, GhosttyFrame } from "@termloop/terminal-surface/ghostty-bridge";
export type GhosttyBridge = SurfaceBridge & {
