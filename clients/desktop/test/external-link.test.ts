...
describe("validatedJiraIssueUrl", () => {
  it("accepts exact HTTPS Jira browse URLs through the external-link channel", () => {
    const jira = "https://example.atlassian.net/browse/EX-697";
  ...
  it("rejects fuzzy and secret-bearing Jira links", () => {
    for (const value of [
      "UKIE-697",
      "http://example.atlassian.net/browse/EX-697",
      "https://user@example.atlassian.net/browse/EX-697",
      "https://example.atlassian.net/browse/EX-697?token=secret",
      "https://example.atlassian.net/browse/ex-697",
      "https://example.atlassian.net/issues/EX-697",
