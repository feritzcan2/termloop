...
describe("workspace view memory", () => {
  it("restores each Project's last workspace view", () => {
    ...
    memory = rememberWorkspaceView(memory, "project-files", "files", storage);
    ...
    expect(workspaceViewForProject(readWorkspaceViewMemory(storage), "project-files")).toBe("files");
