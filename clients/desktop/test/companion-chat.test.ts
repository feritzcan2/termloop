...
describe("Playbook current-state strip", () => {
  const playbook = {
    ...
    milestones: [
      { id: "ms-1", title: "Build green", gate: "automatic", routineId: "routine-1", retryDelaySeconds: 600, condition: "CI green", approver: null },
      { id: "ms-2", title: "Review approved", gate: "automatic", routineId: "routine-2", retryDelaySeconds: 600, condition: "Approved", approver: null },
    ],
